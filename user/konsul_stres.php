    ...
    <script>
        ...
        function displayResultCategory(totalScore) {
            ...
            if (totalScoreForwardChaining >= 0 && totalScoreForwardChaining <= 14) {
                ...
                resultCategory = 'Stres Sangat Berat';
                recommendations = [
            ...
            if (resultCategory === 'Stres Sedang' || resultCategory === 'Stres Berat' || resultCategory === 'Stres Sangat Berat') {
