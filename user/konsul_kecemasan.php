    ...
    <script>
        ...
        function displayResultCategory(totalScore) {
            ...
            if (totalScoreForwardChaining >= 0 && totalScoreForwardChaining <= 7) {
                ...
                resultCategory = 'Kecemasan Sedang';
                recommendations = [
                ...
                resultCategory = 'Kecemasan Berat';
                recommendations = [
                ...
                resultCategory = 'Kecemasan Sangat Berat';
                recommendations = [
            ...
            if (resultCategory === 'Kecemasan Sedang' || resultCategory === 'Kecemasan Berat' || resultCategory === 'Kecemasan Sangat Berat') {
