            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12 d-flex align-items-center">
                    <div class="about-text">
                        <span class="small-text">Halo, Selamat Datang</span>
                        <h1 class="animated animated-text">
                            <span class="mr-2">Apakah kamu merasa</span>
                            <div class="animated-info">
                                <span class="animated-item">Stres?</span>
                                <span class="animated-item">Cemas?</span>
                                <span class="animated-item">Depresi?</span>
                            </div>
                        </h1>
                        <p>Dengan SERENITY kamu dapat mendeteksi kesehatan mental.</p>
                        <div class="custom-btn-group mt-4">
                            <a href="register.php" class="btn custom-btn custom-btn-bg1 custom-btn-link">Register</a>
                            <a href="login.php" class="btn custom-btn custom-btn-bg custom-btn-link">Login</a>
                        </div>
                    </div>
                </div>
